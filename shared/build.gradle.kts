...
kotlin {
    ...
    sourceSets {
        ...
        androidMain.dependencies {
             ...
             * typed API and the view that hosts the video. Lite ships the classic v0.23.0-era
             * JNI binding (is.xyz.mpv.MPVLib) plus its proven native libraries from jniLibs. */
